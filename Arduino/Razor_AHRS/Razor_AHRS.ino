...
const float magn_ellipsoid_center[3] = {148.987, -27.0587, -74.8091};
const float magn_ellipsoid_transform[3][3] = {{0.943644, 0.00735318, -0.00160948}, {0.00735318, 0.940279, 0.00851277}, {-0.00160948, 0.00851277, 0.998781}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -4.0)
#define GYRO_AVERAGE_OFFSET_Y ((float) -15.66)
#define GYRO_AVERAGE_OFFSET_Z ((float) -28.91)
