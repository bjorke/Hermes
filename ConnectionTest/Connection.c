...
char * randomValues(){
  ...
  time_t t;
  int val1 = generateRandomVal(t)*0.93;
  int val2 = generateRandomVal(t)*1.23;
  int val3 = generateRandomVal(t)*1.32;
  int val4 = generateRandomVal(t)*0.65;
  int val5 = generateRandomVal(t)*1.32;

  sprintf(string,"!%i,%i,%i,%i,%i,3\n",val1,val2,val3,val4,val5);
